...
const DEFAULT_MODELS: ModelInfo[] = [
  ...
  { id: 'combo/Antigravity', name: 'Combo Antigravity Failover', providerId: 'openai', providerName: 'OpenCodex Combo', speed: 'Auto Failover', context: '1M', contextTokens: 1048576, inputPrice1M: 0.15, cachedPrice1M: 0.0375, outputPrice1M: 0.60, reasoning: 'Auto Failover', tag: 'High Availability', status: 'active' },
  ...
  { id: 'alibaba-token-plan-intl/kimi-k2.5', name: 'Kimi K2.5', providerId: 'alibaba-token-plan-intl', providerName: 'Alibaba Token Plan', speed: 'Fast Long-Context', context: '256k', contextTokens: 256000, inputPrice1M: 0.80, cachedPrice1M: 0.16, outputPrice1M: 2.40, reasoning: 'High Context Reasoning', tag: 'Long Context', status: 'active' }
];
