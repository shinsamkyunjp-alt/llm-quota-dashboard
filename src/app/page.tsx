...
const DEFAULT_MODELS: ModelInfo[] = [
  // Google Antigravity
  { id: 'google-antigravity/gemini-3.7-flash', name: 'Gemini 3.7 Flash', providerId: 'google-antigravity', providerName: 'Google Antigravity', speed: 'Ultra High (150+ t/s)', context: '1,000,000 (1M)', contextTokens: 1000000, inputPrice1M: 0.15, outputPrice1M: 0.60, reasoning: 'Hybrid Thinking', status: 'active' },
  { id: 'google-antigravity/gemini-3.1-pro', name: 'Gemini 3.1 Pro', providerId: 'google-antigravity', providerName: 'Google Antigravity', speed: 'Fast (80+ t/s)', context: '1,000,000 (1M)', contextTokens: 1000000, inputPrice1M: 1.25, outputPrice1M: 5.00, reasoning: 'Deep Reasoning', status: 'active' },
  ...
  { id: 'combo/Antigravity', name: 'Combo Antigravity Failover', providerId: 'openai', providerName: 'OpenCodex Combo', speed: 'Auto Failover', context: '1,000,000 (1M)', contextTokens: 1000000, inputPrice1M: 0.15, outputPrice1M: 0.60, reasoning: 'Auto Failover', status: 'active' },
  ...
  { id: 'alibaba-token-plan-intl/qwen3.8-max', name: 'Qwen 3.8 Max', providerId: 'alibaba-token-plan-intl', providerName: 'Alibaba Token Plan', speed: 'Heavy Duty', context: '131,072 (131k)', contextTokens: 131072, inputPrice1M: 1.60, outputPrice1M: 6.40, reasoning: 'XHigh Reasoning', status: 'rate_limited' },
  { id: 'alibaba-token-plan-intl/qwen3.7-max', name: 'Qwen 3.7 Max', providerId: 'alibaba-token-plan-intl', providerName: 'Alibaba Token Plan', speed: 'Heavy Duty', context: '131,072 (131k)', contextTokens: 131072, inputPrice1M: 1.60, outputPrice1M: 6.40, reasoning: 'XHigh Reasoning', status: 'rate_limited' },
  { id: 'alibaba-token-plan-intl/deepseek-v4-pro', name: 'DeepSeek V4 Pro', providerId: 'alibaba-token-plan-intl', providerName: 'Alibaba Token Plan', speed: 'Code & Math', context: '128,000 (128k)', contextTokens: 128000, inputPrice1M: 0.27, outputPrice1M: 1.10, reasoning: 'High-Max', status: 'rate_limited' },
  { id: 'alibaba-token-plan-intl/deepseek-v4-flash-0731', name: 'DeepSeek V4 Flash', providerId: 'alibaba-token-plan-intl', providerName: 'Alibaba Token Plan', speed: 'Fast Inference', context: '128,000 (128k)', contextTokens: 128000, inputPrice1M: 0.14, outputPrice1M: 0.28, reasoning: 'Standard', status: 'rate_limited' },
      ...
      <main className="w-full max-w-[1360px] mx-auto px-3 py-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 box-border">
        ...
        <section className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-6 box-border items-stretch">
          ...
          <div className="w-full bg-white border border-amber-200/90 rounded-2xl p-4 sm:p-6 flex flex-col justify-between space-y-4 shadow-sm hover:shadow-md transition-shadow box-border overflow-hidden">
            ...
            <div className="space-y-1.5 pt-2.5 border-t border-zinc-100">
              <div className="text-[10px] font-semibold text-zinc-500 uppercase tracking-wider">영향받는 모델 (1M 및 131k Context)</div>
              <div className="flex flex-wrap gap-1">
